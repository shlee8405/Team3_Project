...
@font-face {
    ...
    @font-face {
        font-family: CJU;
        src: url(/resources/fonts/CJU-Bold.ttf);
    }
...
.container-title {
	...
	font-size: 72px;
	margin-bottom:0px;
	/* background: -webkit-linear-gradient(rgba(99,127,66,0.9),rgba(15,66,0,0.9) ); */
	background: -webkit-linear-gradient(90deg, rgba(147,188,136,0.84) 0%, rgba(180,188,136,0.84) 35%, rgba(200,180,146,0.84) 100%); 
	...
	/*
	 $(document).ready(function() {
        ...
        $(document).ready(()=>{
        	...
        	if(writeStatus == "ok") {
        		alert('성공적으로 모임을 생성하셨습니다.')
        		<% session.removeAttribute("writeStatus"); %>
        	} else if (writeStatus == "fail") {
        		alert('모임을 생성하지 못했습니다. 개발자에게 문의하세요.');
        		<% session.removeAttribute("writeStatus"); %>
        	}
        })
</script>
		...
		<form action="/search.do" method="get">
			<div class="serch_all" style="width: 800px">
				...
				<div class="search-container">
					<div class="search-box ms-5" style="background-color:rgba(20,20,20,0.01);">
