...
<body>
	...
	<div class="container">
		...
		<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#signupModal">회원가입</button>
				            ...
				            <form action="/signupOk.do" method="post">
				                ...
				                <h2 class="title">회원가입</h2>
				                    <div class="input-div one">
				                        ...
				                        <div class="div">
				                            <h5>아이디</h5>
				                            <input type="text" class="input" name="u_id">
				                        </div>
				                    </div>
				                    <div class="input-div pass">
				                        ...
				                        <div class="div">
				                            <h5>패스워드</h5>
				                            <input type="password" class="input" name="u_pw">
				                        </div>
				                    </div>
				                    <div class="input-div one">
				                        <div class="i">
				                     ...
				                     <div class="input-div one">
				                        ...
				                        <div class="div">
				                            <h5>생년월일</h5>
				                            <input type="text" class="input" name="u_birthday">
				                        </div>
				                    </div>
				                     <div class="input-div one">
				                        <div class="i">
				                        ...
				                        <div class="div">
				                            <h5>동의</h5>
				                            <input type="checkbox" class="checkbox" name="u_terms">
				                        </div>
				                    </div>
