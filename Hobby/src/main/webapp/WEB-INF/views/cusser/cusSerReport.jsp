...
<body>
    <jsp:include page="../header.jsp" />
		...
		<ul class="nav nav-tabs nav-justified border-0" style="font-size: 30px;">
		  <li class="nav-item">
		    <a class="nav-link " aria-current="page" style="color: black;" href = "/cusSerFAQ.do"><strong>FAQ</strong></a>
		  </li>
		  <li class="nav-item">
		    <a class="nav-link" href="/cusSerAsk.do" style="color: black;"><strong>QnA</strong></a>
		  </li>
		  <li class="nav-item">
		    <a class="nav-link active border border-4 rounded border-success" href="/cusSerReport.do" style="color: black;"><strong>REPORT</strong></a>
		  </li>
		</ul>
		    <!-- 검색창 추가 -->
